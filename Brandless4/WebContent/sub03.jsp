...
<div class="wrap">
	...
	<div class="agree">	
		<a class="agreement">
			<p> <br>
제1조(목적)이 약관은 브랜드리스 회사(전자상거래 사업자)가 운영하는 브랜드리스 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.<br>
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」		
			</p> <br><br>
			<p>
제2조(정의)<br>
① “몰”이란 브랜드리스 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
...
② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.<br>
			...
			<p>
"제품 등록 과정에서 오류(오타 혹은 오인정보 표기 및 유사한 실수)가 발생할 수 있고 제품 가격이 잘못 표시될 수 있습니다. 제품의 올바른 가격이 웹사이트에 표시된 가격과 다른 경우, 기존 주문이 취소되고 정상가격으로 새로 주문할 수 있습니다"<br>
			</p><br>
			<p>
부 칙(시행일) 이 약관은 2019년 01월 01일부터 시행합니다.<br>
			</p><br>
			<p>
#카카오톡 알림톡 시행에 관한 내용<br>
			</p><br>
			<p>
“브랜드리스”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.<br>
			</p><br>
			<p>
-개인정보의 위탁 처리<br>
			</p><br>
...
#카카오톡 알림톡 시행에 관한 내용<br>
			...
			<p>
“브랜드리스”는 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다. “브랜드리스” 의 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다.<br>
			</p><br>
			<p>
#카카오톡 상담톡 시행에 관한 내용<br>
“(브랜드리스)”은 상담업무를 카카오톡 상담톡으로 진행하며, 만약 카카오톡을 통해 안내되는 상담 내용을 Wi-Fi 나 PC가 아닌 이동통신망으로 이용할 경우, 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 상담을 원치 않으실 경우 고객센터, 게시판 문의를 이용해 주시기 바랍니다.<br>
			</p><br>
			<p>
- 수탁자 : (주)루나소프트<br>
			</p><br>
