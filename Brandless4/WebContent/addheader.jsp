	...
	<div class="hd_wrap">
		<nav class="tnb">
			...
			<ul class="right">
				...
				<% 
					} else if(session.getAttribute("m_id").equals("admin")) {
				%>
				<li><%=m_id %>님 환영합니다</li>
				<li><a href="../logoutProc.jsp">로그아웃</a></li><br>
				<li><a href="../GetTestproductListCtrl">제품 관리</a></li>
				<li><a href="../testmemberlist.jsp">회원관리</a></li>
				<li><a href="../mypage1.jsp">마이페이지</a></li>
				<% 
					} else {
				%>
				<li><%=m_id %>님 환영합니다</li><br>
	...
	<div class="hd_wrap">
		<nav class="gnb">
			<ul>
				...
				<li><a href="../GetTestnoticeListCtrl" class="dp1">게시판</a></li>
			</ul>
		</nav>
	</div>
</header>