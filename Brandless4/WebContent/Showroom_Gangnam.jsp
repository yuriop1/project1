...
<title>쇼룸 안내</title>
    ...
    <script> 
    function initialize() {
    var myLatlng = new google.maps.LatLng(37.496207658534175, 127.03214037401388);
    var mapOptions = {
        zoom: 17, 
        center: myLatlng
    }
...
<div class="all">
<h4 class="tit2">< 강남점 ></h4>

	<div class="map_area">
	    <div id="map_canvas" style="width:600px; height:400px"></div>
	</div> 
		<p class="address">
서울특별시 강남구 테헤란로 8길 42 퍼스트역삼 빌딩 3층<br>
02-568-1553<br>
010-5130-2407(영업시간중 응대가능)<br>
월-일 11시-20시<br>
주차 가능<br>
		</p>  
</div>
