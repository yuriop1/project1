...
.bs_tit { font-family: 'Nanum Gothic', sans-serif; clear: both; display: block; text-align: left;  margin-left: 9%; margin-top:40px;  font-size: 20px;}
...
<div class="wrap">
	<h2 class="con_tit">브랜드 스토리</h2>
       <ul class="art01">
			<li class="bs_line"></li>
			<li class="bs">
    	       <p class="bs_tit">#1. 브랜드리스 탄생 스토리</p><br>	    
    	    </li>
    	    <li>
    	    	<p class="bs_sub">작성자 대표 관리자 작성일 2018-08-23 08:42:34</p><br>	    
    	    </li>
    	    <li class="tc_con">   
               <img src="./img/st1_1.jpg" alt="기업설명" class="img1">   	                	    	       
               <img src="./img/st1_2.jpg" alt="기업설명" class="img2">
           </li>
		</ul>
		<div class="btn_wrap">
