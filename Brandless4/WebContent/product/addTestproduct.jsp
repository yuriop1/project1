...
<div class="content">
	<h2 class="con_tit">제품추가</h2>
	<form action="../AddTestproductCtrl" method="post" name="frm">
		<table class="table">
		<tr>	
		...
		<tr>	
			...
			<td class="item2">
			<span>관리자</span>
				<input type="hidden" name="pid" id="pid" value="관리자" />
			</td>
		</tr>	
		<tr>	
			<th class="item1">분류</th>
			<td class="item2">
				<input type="text" name="pstar" id="pstar" value="" />
			</td>
		</tr>	
		</table>
		<div class="btn-group">
