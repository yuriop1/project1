...
.btn-group { width: 500px; margin-right: 350px; margin-top: 10px; }
.btn-group a { padding: 0 20px;  text-align: center; font-size: 16px;}
...
<div class="content">
   ...
   <form action="" method="post" name="frm">
      ...
      <div class="btn-group">
         <a href="GetTestproductListCtrl" class="in_btn">목록</a>
         <a href="DeleteTestproductCtrl?pcode=<%=testproduct.getPcode() %>" class="in_btn">제품삭제</a>
      </div>
   </form>
</div>
